...
pub struct TIM5EN_R(crate::FieldReader<bool, TIM5EN_A>);
impl TIM5EN_R {
    #[inline(always)]
...
impl core::ops::Deref for TIM5EN_R {
    type Target = crate::FieldReader<bool, TIM5EN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
