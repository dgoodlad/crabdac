...
pub struct MCO1EN_R(crate::FieldReader<bool, MCO1EN_A>);
impl MCO1EN_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        MCO1EN_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for MCO1EN_R {
    type Target = crate::FieldReader<bool, MCO1EN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> MCO2EN_W<'a> {
    ...
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(MCO2EN_A::DISABLED)
    }
    #[doc = "MCO output enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(MCO2EN_A::ENABLED)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
