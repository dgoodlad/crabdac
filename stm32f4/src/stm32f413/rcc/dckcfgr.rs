...
pub type CKDFSDM1ASEL_A = CKDFSDM2ASEL_A;
#[doc = "Field `CKDFSDM1ASEL` reader - DFSDM1 audio clock selection."]
pub type CKDFSDM1ASEL_R = CKDFSDM2ASEL_R;
...
pub struct PLLI2SDIVR_R(crate::FieldReader<u8, PLLI2SDIVR_A>);
impl PLLI2SDIVR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PLLI2SDIVR_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for PLLI2SDIVR_R {
    type Target = crate::FieldReader<u8, PLLI2SDIVR_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct PLLDIVR_R(crate::FieldReader<u8, PLLDIVR_A>);
impl PLLDIVR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PLLDIVR_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for PLLDIVR_R {
    type Target = crate::FieldReader<u8, PLLDIVR_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct CKDFSDM2ASEL_R(crate::FieldReader<bool, CKDFSDM2ASEL_A>);
impl CKDFSDM2ASEL_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CKDFSDM2ASEL_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for CKDFSDM2ASEL_R {
    type Target = crate::FieldReader<bool, CKDFSDM2ASEL_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
