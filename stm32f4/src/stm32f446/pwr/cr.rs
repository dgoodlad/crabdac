...
pub struct FMSSR_R(crate::FieldReader<bool, bool>);
impl FMSSR_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        FMSSR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FMSSR_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct FISSR_R(crate::FieldReader<bool, bool>);
impl FISSR_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        FISSR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FISSR_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
